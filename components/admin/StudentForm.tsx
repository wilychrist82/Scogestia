    ...
    <div className="max-w-4xl mx-auto w-full">
      ...
      <form onSubmit={handleSubmit} className="bg-[var(--color-surface-container-lowest)] border border-[var(--color-outline-variant)] rounded-xl overflow-hidden shadow-sm">
        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold text-[var(--color-on-surface)] mb-2" htmlFor="date_naissance">
                Date de naissance <span className="text-[var(--color-status-retard-text)]">*</span>
              </label>
              <div className="relative">
                <input 
                  className="w-full h-12 bg-[var(--color-surface-container-lowest)] border border-[var(--color-outline-variant)] rounded-lg pl-4 pr-10 text-base focus:outline-none focus:border-[var(--color-primary)] focus:border-2 transition-all" 
                  id="date_naissance" 
                  name="date_naissance" 
                  required 
                  type="date"
