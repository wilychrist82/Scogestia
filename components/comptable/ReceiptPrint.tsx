    ...
    <div className="relative bg-white print:p-0">
      ...
      <div className="flex justify-between items-end mt-8 pt-4">
        ...
        <div className="text-center relative">
          ...
          <div className="h-24 w-full flex items-center justify-center gap-2 mx-auto">
            {data.directorSignature && (
              <img src={data.directorSignature} alt="Signature" className="h-full max-w-[120px] object-contain mix-blend-multiply" />
            )}
            {data.schoolStamp && (
              <img src={data.schoolStamp} alt="Cachet" className="h-full max-w-[120px] object-contain mix-blend-multiply" />
            )}
          </div>
