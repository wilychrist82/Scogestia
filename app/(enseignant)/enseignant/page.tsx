...
export default async function EnseignantDashboardPage() {
  ...
  return (
    <div className="flex flex-col min-h-full bg-gray-50/50 pb-8">
      ...
      <div 
        className="relative px-6 rounded-b-[2.5rem] shadow-lg h-[220px] md:h-[260px] flex items-end"
        style={{
      ...
      <div className="px-4 md:px-8 space-y-6 -mt-8 md:-mt-10 relative z-20 max-w-[1280px] mx-auto w-full">
