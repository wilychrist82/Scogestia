  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="bg-gradient-to-r from-[var(--color-primary)] to-[#147a63] rounded-2xl p-5 shadow-lg text-white">
        ...
        <Link href="/parent/paiements" className="w-full bg-white text-[var(--color-primary)] py-3 rounded-xl font-bold flex justify-center gap-2 items-center hover:opacity-90 active:scale-95 transition-transform shadow-sm">
          Voir les paiements
