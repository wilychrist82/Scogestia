  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-[#006039]/20 selection:text-[#006039]">
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            >
              ...
              <motion.div variants={fadeIn} className="md:col-span-4 h-[400px] rounded-[2rem] p-10 relative overflow-hidden group">
                <img src="/images/parents.png" alt="Portail Parent" className="absolute inset-0 w-full h-full object-cover object-right transition-transform duration-700 group-hover:scale-105" />
      ...
      <footer id="contact" className="bg-[#09090b] text-slate-300 pt-16 pb-10 relative overflow-hidden border-t-2 border-violet-900/30">
        ...
        <div className="absolute top-16 left-1/2 -translate-x-1/2 w-full flex justify-center pointer-events-none select-none z-0">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a href="https://wa.me/22892102868" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                    ...
                    <span className="text-slate-400 group-hover:text-emerald-500 transition-colors">WhatsApp</span>
                  </a>
                </li>
