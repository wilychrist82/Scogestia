          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            >
              ...
              <motion.div variants={fadeIn} className="md:col-span-4 h-[400px] rounded-[2rem] p-10 relative overflow-hidden group">
                <img src="/images/parents.png" alt="Portail Parent" className="absolute inset-0 w-full h-full object-cover object-[right_top] transition-transform duration-700 group-hover:scale-105" />
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a href="https://wa.me/22892102868" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
                    ...
                    <span className="text-slate-400 group-hover:text-emerald-500 transition-colors">WhatsApp <span className="text-xs text-slate-500 ml-1">(Cliquez ici)</span></span>
                  </a>
                </li>
