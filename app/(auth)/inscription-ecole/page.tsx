    ...
    <main className="flex min-h-screen bg-white overflow-hidden font-sans">
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-[#002116] text-white p-12 flex-col justify-center items-center relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md flex flex-col items-center">
          ...
          <div className="mt-4 w-full relative rounded-xl overflow-hidden shadow-2xl border border-emerald-400/30 group bg-[#001810] transform transition-all duration-700 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
             {/* Barre de navigateur mini */}
             <div className="h-8 bg-slate-900/90 border-b border-white/10 flex items-center px-3 gap-1.5 backdrop-blur-md">
                <div className="w-2.5 h-2.5 rounded-full bg-slate-700 group-hover:bg-red-400 transition-colors"></div>
                <div className="w-2.5 h-2.5 rounded-full bg-slate-700 group-hover:bg-amber-400 transition-colors delay-75"></div>
                <div className="w-2.5 h-2.5 rounded-full bg-slate-700 group-hover:bg-emerald-400 transition-colors delay-150"></div>
             </div>
