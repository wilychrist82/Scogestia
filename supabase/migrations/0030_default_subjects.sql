...
begin
  ...
  values
    -- Primaire
    (v_school_id, 'Français', 'primaire', 'Français', 1.0),
    (v_school_id, 'Mathématiques', 'primaire', 'Mathématiques', 1.0),
    (v_school_id, 'EAC', 'primaire', 'EAC', 1.0),
    (v_school_id, 'Histoire-Géo', 'primaire', 'Histoire-Géo', 1.0),
    (v_school_id, 'Sciences', 'primaire', 'Sciences', 1.0),
    (v_school_id, 'Anglais', 'primaire', 'Langues', 1.0),
    -- Secondaire
    (v_school_id, 'Français', 'secondaire', null, 3.0),
    (v_school_id, 'Mathématiques', 'secondaire', null, 4.0),
    (v_school_id, 'SVT', 'secondaire', null, 2.0),
    (v_school_id, 'Physique-Chimie', 'secondaire', null, 2.0),
    (v_school_id, 'Anglais', 'secondaire', null, 2.0),
    (v_school_id, 'Histoire-Géo', 'secondaire', null, 2.0),
    (v_school_id, 'Philosophie', 'secondaire', null, 2.0),
...
BEGIN
  ...
  LOOP
    ...
    IF NOT EXISTS (SELECT 1 FROM public.subjects WHERE school_id = sch.id) THEN
      ...
      values
        -- Primaire
        (sch.id, 'Français', 'primaire', 'Français', 1.0),
        (sch.id, 'Mathématiques', 'primaire', 'Mathématiques', 1.0),
        (sch.id, 'EAC', 'primaire', 'EAC', 1.0),
        (sch.id, 'Histoire-Géo', 'primaire', 'Histoire-Géo', 1.0),
        (sch.id, 'Sciences', 'primaire', 'Sciences', 1.0),
        (sch.id, 'Anglais', 'primaire', 'Langues', 1.0),
        -- Secondaire
        (sch.id, 'Français', 'secondaire', null, 3.0),
        (sch.id, 'Mathématiques', 'secondaire', null, 4.0),
        (sch.id, 'SVT', 'secondaire', null, 2.0),
        (sch.id, 'Physique-Chimie', 'secondaire', null, 2.0),
        (sch.id, 'Anglais', 'secondaire', null, 2.0),
        (sch.id, 'Histoire-Géo', 'secondaire', null, 2.0),
        (sch.id, 'Philosophie', 'secondaire', null, 2.0),
